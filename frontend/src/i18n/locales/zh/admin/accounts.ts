export default {
    accounts: {
      ...
      createAccount: '添加账号',
      codebuddyOAuth: {
        title: 'WorkBuddy / CodeBuddy 扫码登录',
        site: '站点',
        siteCN: '国内 (codebuddy.cn)',
        siteIntl: '国际 (workbuddy.ai)',
        creditPolicy: '积分消耗',
        creditPolicyHint: '仅 0 积分模型会过滤账号可用模型列表，并拒绝消耗积分的上游请求。',
        creditPolicyAll: '全部模型',
        creditPolicyZero: '仅 0 积分模型',
        probeCredits: '查询积分',
        creditsRemaining: '剩余 {count} 积分',
        creditsExpiry: '最早到期 {time}',
        creditsExpiryOverdue: '已过期',
        creditsExpiryWithinMinutes: '{count} 分钟内',
        creditsExpiryWithinHours: '{count} 小时内',
        creditsExpiryWithinDays: '{count} 天内',
        creditsSegmentDefault: '积分',
        creditsPackages: '积分包',
        creditsEstimated: '估算',
        creditsEstimatedHint: '自上次查询后由网关按模型倍率本地推算，点击「查询积分」可与上游对齐。',
        creditsExhausted: '已耗尽',
        creditsUsedToday: '今日消耗 {credits} 积分 / {requests} 次',
        creditsGatewayOnly: '（仅本网关）',
        creditsUsedTotal: '本网关累计 {credits} 积分 / {requests} 次',
        creditsOfficialWindow: '官方账单近 {days} 天：{credits} 积分 / {requests} 次',
        creditsUnpriced: '其中 {count} 次的模型不在目录中，未计入积分',
        creditsFetchedJustNow: '刚刚更新',
        creditsFetchedMinutes: '{minutes} 分钟前更新',
        creditsFetchedHours: '{hours} 小时前更新',
        start: '开始扫码登录',
        restart: '重新发起登录',
        cancel: '取消等待',
        waiting: '请在打开的页面完成扫码，确认登录成功前请勿关闭。',
        openUrl: '打开登录页',
        copyUrl: '复制链接',
        linkCopied: '登录链接已复制',
        polling: '等待扫码授权中…',
        done: '登录成功',
        importJson: '或粘贴官方 .info 凭据 JSON',
        importPlaceholder: '粘贴 CodeBuddy / WorkBuddy 的 .info JSON',
        invalidJson: '凭据 JSON 格式无效，请检查后重试',
        create: '创建账号',
        failedToStart: '发起 CodeBuddy 登录失败',
        failedToPoll: '轮询 CodeBuddy 登录状态失败',
        failedToCreate: '创建 CodeBuddy 账号失败',
      ...
      cursorProxy: {
        ...
        grokOAuth: 'Grok OAuth',
        grokOAuthOpen: '打开 Grok OAuth',
        grokOAuthWait: '正在打开…',
        grokOAuthOpening: '正在打开 Grok OAuth…',
        grokOAuthPasteCode: '请在浏览器完成登录，然后粘贴授权码。',
        grokOAuthCodePlaceholder: '授权码',
        grokOAuthExchange: '兑换授权码',
        grokOAuthFailed: 'Grok OAuth 失败',
        grokOAuthSuccess: 'Grok OAuth 成功，已回填 token。',
        grokOAuthSuccessEmail: 'Grok OAuth 成功（{email}）',
        machineId: '机器 ID（可选）',
        cliLogin: 'Cursor CLI 登录',
        cliLoginWait: '等待浏览器登录…',
        cliLoginOpen: '打开 CLI 登录',
        sessionToken: 'CLI 会话令牌',
        sessionTokenRequired: '请填写 Cursor 会话令牌',
        sessionTokenCreatePlaceholder: 'eyJ... 或点击上方 CLI 登录',
        sessionTokenEditPlaceholder: '留空保持原令牌',
        sessionTokenHint: '走 Cursor IDE 额度。使用 Cursor CLI 登录拿到的 session JWT，不要填 grok_bot 或 Origin CLI token。',
      ...
      qoderProxy: {
        ...
        keepHint: '留空则保持原令牌。',
        personalTokenReplacesLogin: '填写新令牌会替换当前的设备登录。',
        machineId: '机器 ID（可选）',
        machineIdPlaceholder: '留空自动生成',
        machineIdHint: 'COSY 请求头里的设备标识，同一账号保持不变即可；设备登录会自动回填。',
        platformHint: '通过 Qoder 提供 Chat Completions、Anthropic Messages（Claude Code）和 Responses（Codex）接口，消耗该账号的额度。',
        credentialRequired: '请登录 Qoder，或填写 Personal Access Token',
        oauth: 'Qoder 登录',
        oauthOpen: '打开浏览器登录',
        oauthWait: '等待登录…',
        oauthOpening: '正在打开 Qoder 登录页…',
        oauthWaiting: '请在打开的窗口完成登录，完成后会自动回填。',
        oauthOpenLink: '窗口没有弹出？点此打开登录页',
        oauthTimeout: '登录超时，请重试或改填 Personal Access Token。',
        oauthSuccess: '登录成功，保存账号后设备令牌生效。',
        oauthFailed: '无法启动 Qoder 登录',
        oauthLoggedIn: '已登录：{user}',
        oauthHint: '在 Qoder 官网授权后自动回填令牌，到期前网关会自动续期。',
        oauthRelogin: '重新登录',
        oauthRemaining: '剩余 {time}',
        oauthCopyLink: '复制登录链接',
        oauthLinkCopied: '已复制',
        deviceLogin: '浏览器设备登录',
        recommended: '推荐',
        or: '或',
        personalTokenSaved: '已保存',
        credentialSummaryBoth: '保存后优先使用设备登录，个人访问令牌作为备用。',
        credentialSummaryDevice: '保存后使用设备登录。',
        credentialSummaryPAT: '保存后使用个人访问令牌。',
        advanced: '高级设置',
        edition: '版本',
      ...
      qoderQuota: {
        refresh: '刷新额度',
        refreshing: '查询中…',
        failed: '查询 Qoder 额度失败',
        never: '尚未查询额度',
        credits: '积分',
        remaining: '剩余 {value} {unit}',
        remainingTitle: '所有可用额度池的剩余合计',
        exceeded: '额度已用尽',
        noPools: '该账号没有可展示的额度池',
        morePools: '另有 {count} 个额度池',
        poolDetail: '已用 {used} / {total} {unit}，剩余 {remaining}',
        resetsAt: '{time} 重置',
        expiresAt: '{time} 到期',
        unavailable: '已失效或不可用',
        checkedAt: '{time}查询',
      ...
      grokAccount: 'Grok 账号',
      codebuddyAccount: 'WorkBuddy / CodeBuddy 账号',
      inputMethod: '输入方式',
