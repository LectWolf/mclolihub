export default {
  ...
  keys: {
    ...
    smartRoutingHint: 'When enabled, groups are tried in the added order. Protocol mismatches, rates above the max multiplier, and failed probes are skipped. Billing uses the group that actually served the request.',
    smartRoutingAdd: 'Add route',
    smartRoutingEmpty: 'Add at least one group',
    smartRoutingMax: 'You can add at most 10 groups',
    smartRoutingChangeInEditor: 'Click to add or reorder smart routing groups',
    routeModeLabel: 'Routing mode',
    routeModes: { fixed: 'Fixed group', smart: 'Smart routing' },
    ...
    smartRouteGroups: 'Smart routing groups',
    smartRouteHint: 'Turn a group on to include it, then drag to set priority. Groups over the max multiplier or with a failed probe are skipped.',
    smartRouteRequired: 'Smart routing needs at least one group',
