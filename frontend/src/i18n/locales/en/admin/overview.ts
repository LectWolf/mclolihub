export default {
    ...
    dashboard: {
      ...
      todayOverview: 'Today',
      deltaCaption: 'Changes compare with the same period yesterday',
      statsUpdatedAt: 'Generated at {time}',
      statsStale: 'Stats delayed',
      statsStaleHint: "Pre-aggregated stats were last updated at {time}; today's numbers may lag",
      yesterdaySamePeriod: 'Same period yesterday: {value}',
      noYesterdayData: 'No comparable data for the same period yesterday',
      todaySpend: "Today's Spend",
      todaySpendHint: 'Total actually charged to users (after group multipliers and discounts) — i.e. platform revenue.',
      todayProfit: "Today's Gross Profit",
      todayProfitHint: "Actual charges − account cost. Account cost is derived from each account's billing multiplier (or account stats pricing).",
      standardCostValue: 'Standard {value}',
      accountCostValue: 'Cost {value}',
      marginValue: 'Margin {value}',
      marginLabel: 'Margin',
      cumulativeValue: 'All-time {value}',
      cacheHitValue: 'Cache hit {value}',
      tokenBreakdown: 'Input {input} · Output {output} · Cache write {cacheWrite} · Cache read {cacheRead}',
      accountPool: 'Account Pool',
      accountPoolHint: 'Accounts are split into mutually exclusive states using the same rules as the account list status filter. Click a state to open the filtered list.',
      schedulableOfTotal: 'Schedulable / total accounts',
      activeOfTotal: 'Active / total accounts',
      errorAccountsFallback: '{n} accounts in error',
      overloadedHint: '{n} of them are overloaded upstream',
      accountHealth: {
        available: 'Schedulable',
        rateLimited: 'Rate limited',
        tempUnschedulable: 'Temporarily unschedulable',
        unschedulable: 'Paused',
        balanceInsufficient: 'Balance exhausted',
        error: 'Error',
        inactive: 'Disabled',
        other: 'Other'
      },
      usersCard: 'Users & Keys',
      newUsersValue: '+{n} today',
      activeUsersValue: '{n} active today',
      hourlyActiveUsersValue: '{n} this hour',
      apiKeysValue: 'API keys {total} · {active} enabled',
      realtimeLoad: 'Live Load',
      realtimeLoadHint: 'RPM / TPM are per-minute averages over the last 5 minutes; TPM counts input and output tokens only.',
      todayAvgResponseValue: 'Avg response today {value}',
      uptimeValue: 'Up for {value}',
      uptimeUnits: {
        day: 'd',
        hour: 'h',
        minute: 'm'
      ...
      spendTrend: 'Spend & Cost Trend',
      spendTrendHint: 'Actual spend is what users are charged, account cost is the upstream account cost, and gross profit = actual spend − account cost.',
      seriesActualCost: 'Actual spend',
      seriesAccountCost: 'Account cost',
      seriesProfit: 'Gross profit'
    },
    ...
    groups: {
      ...
      refreshHealth: 'Probe now',
      refreshHealthSuccess: 'Group probe completed',
      refreshHealthError: 'Group probe failed',
      sortOrder: 'Sort',
      columnSettings: 'Column Settings',
      ...
      form: {
        ...
        rateMultiplierHint: '0 = free, 1.0 = standard rate, 0.5 = half price, 2.0 = double',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
      ...
      rateMultiplierHint: '0 = free; 1.0 = standard rate; 1.5 = 150% of base cost',
