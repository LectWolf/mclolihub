export default {
    accounts: {
      ...
      codebuddyOAuth: {
        title: 'WorkBuddy / CodeBuddy QR login',
        site: 'Site',
        siteCN: 'China (codebuddy.cn)',
        siteIntl: 'International (workbuddy.ai)',
        creditPolicy: 'Credit usage',
        creditPolicyHint: 'Zero-credit only hides paid models and rejects requests that would consume credits.',
        creditPolicyAll: 'All models',
        creditPolicyZero: 'Zero-credit models only',
        probeCredits: 'Refresh credits',
        creditsRemaining: '{count} credits left',
        creditsExpiry: 'Earliest expiry {time}',
        creditsExpiryOverdue: 'expired',
        creditsExpiryWithinMinutes: 'within {count} min',
        creditsExpiryWithinHours: 'within {count} h',
        creditsExpiryWithinDays: 'within {count} d',
        creditsSegmentDefault: 'Credits',
        creditsPackages: 'Credit packs',
        creditsEstimated: 'Estimated',
        creditsEstimatedHint: 'Drawn down locally from model multipliers since the last probe. Refresh to reconcile with upstream.',
        creditsExhausted: 'Exhausted',
        creditsUsedToday: '{credits} credits over {requests} requests today',
        creditsGatewayOnly: '(this gateway only)',
        creditsUsedTotal: 'This gateway: {credits} credits over {requests} requests',
        creditsOfficialWindow: 'Official billing, last {days}d: {credits} credits over {requests} requests',
        creditsUnpriced: '{count} of them used a model missing from the catalog and were not charged',
        creditsFetchedJustNow: 'Updated just now',
        creditsFetchedMinutes: 'Updated {minutes}m ago',
        creditsFetchedHours: 'Updated {hours}h ago',
        start: 'Start QR login',
        restart: 'Restart login',
        cancel: 'Stop waiting',
        waiting: 'Scan the QR code in the opened page and wait until login is confirmed here.',
        openUrl: 'Open login page',
        copyUrl: 'Copy link',
        linkCopied: 'Login link copied',
        polling: 'Waiting for authorization…',
        done: 'Login succeeded',
        importJson: 'Or paste an official .info credential JSON',
        importPlaceholder: 'Paste CodeBuddy / WorkBuddy .info JSON',
        invalidJson: 'The credential JSON is not valid. Check it and try again.',
        create: 'Create account',
        failedToStart: 'Failed to start CodeBuddy login',
        failedToPoll: 'Failed to poll CodeBuddy login',
        failedToCreate: 'Failed to create CodeBuddy account',
        loginTimeout: 'Login timed out. Please start again.'
      },
      ...
      cursorProxy: {
        sandCredential: 'Sand renewal key',
        sandCredentialHint: 'Counts as the account key. Copy SAND_INFERENCE_RENEWAL_CREDENTIAL from the sandbox host; do not paste a session JWT.',
        sandCredentialRequired: 'Please enter the sand renewal key or a Grok Bot token',
        sandKeepHint: 'Leave empty to keep the current key.',
        grokBotToken: 'Grok Bot token',
        grokBotTokenHint: 'Optional grok_bot JWT. Used as the OAuth Bearer token with Grok Bot request headers. If empty, the sand renewal key is used to mint one.',
        grokOAuth: 'Grok OAuth',
        grokOAuthOpen: 'Open Grok OAuth',
        grokOAuthWait: 'Opening…',
        grokOAuthOpening: 'Opening Grok OAuth…',
        grokOAuthPasteCode: 'Finish login in the browser, then paste the authorization code.',
        grokOAuthCodePlaceholder: 'Authorization code',
        grokOAuthExchange: 'Exchange code',
        grokOAuthFailed: 'Grok OAuth failed',
        grokOAuthSuccess: 'Grok OAuth succeeded, token filled.',
        grokOAuthSuccessEmail: 'Grok OAuth succeeded ({email})',
        machineId: 'Machine ID (optional)',
        cliLogin: 'Cursor CLI login',
        cliLoginWait: 'Waiting for browser login…',
        cliLoginOpen: 'Open CLI login',
        sessionToken: 'CLI session token',
        sessionTokenRequired: 'Please enter the Cursor session token',
        sessionTokenCreatePlaceholder: 'eyJ... or use CLI login above',
        sessionTokenEditPlaceholder: 'Leave empty to keep the current token',
        sessionTokenHint: 'Uses Cursor IDE quota. Paste the session JWT from Cursor CLI login, not a grok_bot or Origin CLI token.',
      ...
      qoderProxy: {
        ...
        personalTokenReplacesLogin: 'A new token replaces the current device login.',
        machineId: 'Machine ID (optional)',
        machineIdPlaceholder: 'Generated automatically when empty',
        machineIdHint: 'Device ID sent in COSY headers. Keep it stable per account; device login fills it in.',
        platformHint: 'Serves Chat Completions, Anthropic Messages (Claude Code) and Responses (Codex) through Qoder and spends this account quota.',
        credentialRequired: 'Sign in to Qoder, or paste a personal access token',
        oauth: 'Qoder login',
        oauthOpen: 'Open browser login',
        oauthWait: 'Waiting for login…',
        oauthOpening: 'Opening the Qoder login page…',
        oauthWaiting: 'Finish login in the opened window. The token is filled in automatically.',
        oauthOpenLink: 'Window did not open? Click here to open the login page',
        oauthTimeout: 'Login timed out. Try again, or paste a personal access token.',
        oauthSuccess: 'Login succeeded. Save the account to keep the device token.',
        oauthFailed: 'Could not start Qoder login',
        oauthLoggedIn: 'Signed in: {user}',
        oauthHint: 'Authorize on the Qoder site and the token is filled in. The gateway renews it before it expires.',
        oauthRelogin: 'Sign in again',
        oauthRemaining: '{time} left',
        oauthCopyLink: 'Copy login link',
        oauthLinkCopied: 'Copied',
        deviceLogin: 'Browser device login',
        recommended: 'Recommended',
        or: 'or',
        personalTokenSaved: 'Saved',
        credentialSummaryBoth: 'Device login is used first; the personal access token is the fallback.',
        credentialSummaryDevice: 'The device login will be used.',
        credentialSummaryPAT: 'The personal access token will be used.',
        advanced: 'Advanced',
        edition: 'Edition',
      ...
      qoderQuota: {
        ...
        refreshing: 'Checking…',
        failed: 'Could not query Qoder credits',
        never: 'Credits not checked yet',
        credits: 'credits',
        remaining: '{value} {unit} left',
        remainingTitle: 'Remaining credits across all usable pools',
        exceeded: 'Out of credits',
        noPools: 'This account has no credit pools to show',
        morePools: '{count} more pools',
        poolDetail: '{used} / {total} {unit} used, {remaining} left',
        resetsAt: 'Resets {time}',
        expiresAt: 'Expires {time}',
        unavailable: 'Expired or unavailable',
      ...
      codebuddyAccount: 'WorkBuddy / CodeBuddy Account',
