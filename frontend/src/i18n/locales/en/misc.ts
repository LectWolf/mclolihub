export default {
  ...
  payment: {
    ...
    qr: {
      ...
      alipayWaitingHint:
        "The server will confirm the payment and update this page automatically",
      alipayFallbackTitle: "Alipay did not open",
      alipayFallbackHint:
        "Try opening Alipay again, or save the QR code and scan it from your Alipay photo album",
      reopenAlipay: "Open Alipay Again",
      saveQRCode: "Save QR Code",
      alipaySaveAndScanHint:
        "Save the QR code, open Alipay Scan, then select it from your photo album",
    },
    orders: {
      title: "My Orders",
      empty: "No orders yet",
    ...
    admin: {
      ...
      currencyHint:
        "Display-only 3-letter ISO currency code shown next to the price; leave empty to hide, does not affect billing",
