...
func (tx *Tx) init() {
	...
	tx.APIKeyGroupPreference = NewAPIKeyGroupPreferenceClient(tx.config)
	...
	tx.GroupHealthEvent = NewGroupHealthEventClient(tx.config)
	tx.GroupHealthState = NewGroupHealthStateClient(tx.config)
