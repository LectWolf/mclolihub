...
func init() {
	...
	// apikeyDescRoutePlatform is the schema descriptor for route_platform field.
	apikeyDescRoutePlatform := apikeyFields[5].Descriptor()
	// apikey.DefaultRoutePlatform holds the default value on creation for the route_platform field.
	apikey.DefaultRoutePlatform = apikeyDescRoutePlatform.Default.(string)
	// apikey.RoutePlatformValidator is a validator for the "route_platform" field. It is called by the builders before save.
	apikey.RoutePlatformValidator = apikeyDescRoutePlatform.Validators[0].(func(string) error)
	// apikeyDescNaturalRevertEnabled is the schema descriptor for natural_revert_enabled field.
	apikeyDescNaturalRevertEnabled := apikeyFields[6].Descriptor()
	// apikey.DefaultNaturalRevertEnabled holds the default value on creation for the natural_revert_enabled field.
	apikey.DefaultNaturalRevertEnabled = apikeyDescNaturalRevertEnabled.Default.(bool)
	...
	groupDescProbeEnabled := groupFields[62].Descriptor()
	...
	groupDescProbeModel := groupFields[63].Descriptor()
	...
	groupDescProbeIntervalSeconds := groupFields[64].Descriptor()
	...
	groupDescRetryWithinGroupOnFailover := groupFields[65].Descriptor()
