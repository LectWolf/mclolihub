...
func TestIsSensitiveCredentialKey(t *testing.T) {
	...
	require.True(t, IsSensitiveCredentialKey("sand_inference_renewal_credential"))
	require.True(t, IsSensitiveCredentialKey("grok_bot_token"))
	require.True(t, IsSensitiveCredentialKey("session_token"))
