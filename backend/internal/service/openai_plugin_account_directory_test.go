...
func TestAccountReadableSnapshot_DenylistTripwire(t *testing.T) {
	...
	safeToExpose := map[string]struct{}{
		...
		// Fork-only group health runtime state; already returned by the admin account DTO.
		"HealthRuntimeStatus": {}, "HealthRetryStep": {}, "HealthNextProbeAt": {}, "HealthRuntimeReason": {},
