...
// IsQoder reports Qoder agent-chat accounts (personal access token or device login).
...
func (a *Account) IsOpenAICompatible() bool {
	return a != nil && (a.Platform == PlatformOpenAI || a.Platform == PlatformGrok || a.Platform == PlatformCodeBuddy || a.IsCNProvider() || a.IsOpenCodeGo())
}
