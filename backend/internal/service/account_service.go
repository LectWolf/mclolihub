...
var (
	...
	ErrAccountBalanceRestoreRequired = infraerrors.Conflict("ACCOUNT_BALANCE_RESTORE_REQUIRED", "balance-insufficient accounts must be restored through the dedicated administrator action")
)
