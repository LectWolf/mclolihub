...
func ProvideAdminHandlers(
	...
	accountHandler.SetQoderGatewayService(qoderGateway)
...
func ProvideGatewayHandler(
	...
	h := NewGatewayHandler(gatewayService, openAIGatewayService, geminiCompatService, antigravityGatewayService, cursorGatewayService, qoderGatewayService,
		userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool,
		errorPassthroughService, contentModerationService, userMsgQueueService, cfg, settingService)
	h.securityAuditCoordinator = coordinator
	h.SetGroupHealthService(groupHealthService)
...
func ProvideOpenAIGatewayHandler(
	...
	h.SetDynamicRoutingServices(groupHealthService, subscriptionService)
	return h
}
...
func ProvideHandlers(
	...
	groupHealthHandler *GroupHealthHandler,
	...
	return &Handlers{
		...
		GroupHealth:      groupHealthHandler,
		Admin:            adminHandlers,
