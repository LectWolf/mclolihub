...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		Name:               k.Name,
		GroupID:            k.GroupID,
		RouteMode:          service.NormalizeRouteMode(k.RouteMode),
...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	out := &Account{
		...
		HealthRuntimeStatus:     a.HealthRuntimeStatus,
		HealthRetryStep:         a.HealthRetryStep,
		HealthNextProbeAt:       a.HealthNextProbeAt,
		HealthRuntimeReason:     a.HealthRuntimeReason,
